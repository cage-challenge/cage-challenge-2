...
config = (
    ...
    .offline_data(output=f"logs/APPO/{ITERS}_{BATCH_SIZE}_{RED_AGENT}_no_decoy", output_compress_columns=['prev_actions', 'prev_rewards', 'dones', 't', 'action_prob', 'action_logp', 'action_dist_inputs', 'advantages', 'value_targets'], #'eps_id', 'unroll_id', 'agent_index',
