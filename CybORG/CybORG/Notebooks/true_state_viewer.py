...
def display_tree_red_preds(tree_red_preds):
    ...
    im_preds = []
    for tree_pred in tree_red_preds[index][3]:
    ...
    def update_images(index):
        nonlocal im_pre, im_blue, im_red_true, tree_red_preds, sidebyside_controls, sidebyside_truth_images, sidebyside_pred_images
        ...
        for i, tree_pred in enumerate(tree_red_preds[index][3]):
